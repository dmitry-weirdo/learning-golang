...
func testIntArrayToStringArray(arr []int, expectedResult []string) {
	fmt.Println()
	fmt.Println("========================")

	fmt.Printf("Array: %v \n", arr) // todo: replace with your text

	result := IntArrayToStringArrayFunction(arr) // todo: replace with your function
...
func IntArrayToInt64Function(arr []int) int64 {
	return int64(len(arr))
}

func testIntArrayToInt64(arr []int, expectedResult int64) { // nodes can be null
	fmt.Println()
	fmt.Println("====================")

	fmt.Printf("Array: %v \n", arr) // todo: replace with your text if required

	result := IntArrayToInt64Function(arr) // todo: update to your function
...
func testStringArrayToString(arr []string, expectedResult string) {
	fmt.Println()
	fmt.Println("====================")

	fmt.Printf("Array: %v \n", arr) // todo: replace with your text if required

	result := StringArrayToStringFunction(arr) // todo: update to your function
